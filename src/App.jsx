...
import CakesTypes from "./components/CakesTypes";
import DesignTypes from "./components/DesignTypes";
import FlavorComponent from "./components/FlavorComponent";
import FillingComponent from "./components/FillingComponent";
...
function App() {
  ...
  const [ pisos, setPisos ] = useState(0.00);
  ...
  return (
    <div className="container">
      ...
      <h3 className="my-3">{ `Total: $${totalSum ? totalSum : 0 }` }</h3>
      ...
      <form onSubmit={handleSubmit}>
        ...
        {
          cakeType.map((cake) => {
            if(pisos === 'personalizado' && cake.type === '+60 personas'){
              return (
